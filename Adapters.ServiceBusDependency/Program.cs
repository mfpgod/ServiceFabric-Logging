        ...
        private static void Main()
        {
            try
            {
                ...
                ServiceRuntime.RegisterServiceAsync(
                    "Adapters.ServiceBusDependencyType",
                    context => new ServiceBusDependency(context)).GetAwaiter().GetResult();

                ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(ServiceBusDependency).Name);
